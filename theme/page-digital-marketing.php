...
<?php if (have_rows('digital_marketing_settings')) : ?>
    <?php while (have_rows('digital_marketing_settings')) : the_row();
        ...
        if ($id_graphics_design_settings) { ?>
            ...
            <div class="bg-white px-5 py-16">
                ...
                <?php
                if ($posts) :
                    $digital_marketings = get_sub_field('digital_marketing');

                    foreach ($digital_marketings as $digital_marketing) :
                        setup_postdata($digital_marketing);
                        $digital_marketing_title = get_the_title($digital_marketing->ID);
                        $digital_marketing_permalink = get_permalink($digital_marketing->ID);

                        $digital_marketing_subTitle = get_field('sub_heading', $digital_marketing->ID);
                        $digital_marketing_card = get_field('marketing_card', $digital_marketing->ID);
                        ...
                        <div class="grid grid-cols-1  sm:grid-cols-3  max-w-6xl mx-auto ">
                            ...
                            <div class="mt-10">
                                ...
                                <h4 class="font-semibold capitalize text-lg ">
                                    <?php echo $digital_marketing_subTitle; ?>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 sm:col-start-2 sm:col-end-4 gap-9 my-10  ">
                                ...
                                $marketing_cards = get_field('marketing_card', $digital_marketing->ID);
