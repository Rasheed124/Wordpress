...
<main id="main">
    ...
    <section class="overflow-x-hidden max-w-7xl mx-auto">
        <?php if ( have_rows( 'section_one' ) ) : ?>
            <?php while ( have_rows( 'section_one' ) ) :
                the_row(); ?>
        <div id="<?php if ( $id_section_one = get_sub_field( 'id_section_one' ) ) : ?>
	<?php echo esc_html( $id_section_one ); ?>
<?php endif; ?>"
         ...
         <section class="px-6 lg:px-10 bg-gray-100">
              ...
              <?php if ( have_rows( 'section_eight' ) ) : ?>
                 <?php while ( have_rows( 'section_eight' ) ) : the_row(); ?>
                    <div id="<?php if ( $id_section_eight = get_sub_field( 'id_section_eight' ) ) : ?><?php echo esc_html( $id_section_eight ); ?><?php endif; ?>" class="text-center lg:max-w-6xl mx-auto max-w-2xl  py-14 lg:py-20 xl:py-28">
        ...
        <!-- SECTION  - Bonusess -->
         <section class="px-6 lg:px-10 bg-gray-100">
            <?php if ( have_rows( 'section_nine' ) ) : ?>
                <?php while ( have_rows( 'section_nine' ) ) :
                    the_row(); ?>
                    <div id="<?php if ( $id_section_nine = get_sub_field( 'id_section_nine' ) ) : ?>
                        <?php echo esc_html( $id_section_nine ); ?>
                    <?php endif; ?>" class="text-center lg:max-w-6xl mx-auto max-w-2xl  py-14 lg:py-20 xl:py-28">
                                            <!-- Content -->
                        <div class="max-w-4xl mx-auto">
                        ...
                        <?php if ( have_rows( 'content_section_nine' ) ) : ?>
                            <?php while ( have_rows( 'content_section_nine' ) ) :
                                the_row(); ?>
                         <div class="py-8 max-w-5xl mx-auto flex justify-center items-center">
    ...
    <section class="px-6 lg:px-10">
      ...
      <section class="px-6 lg:px-10 bg-gray-100">
                ...
                <?php while ( have_rows( 'section_ten' ) ) :
                    the_row(); ?>
