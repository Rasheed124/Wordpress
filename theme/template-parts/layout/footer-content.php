...
<footer class="py-14  text-deep-black relative bg-gray-200 ">
  <div class="flex flex-col justify-center items-center w-full">
    ...
    class="hidden fixed z-50 bottom-5 right-5 p-4 border-0 w-14 h-14 rounded-full shadow-md bg-header-dark-overlay hover:bg-header-dark-overlay/75 text-white text-lg font-semibold transition-colors duration-300">
