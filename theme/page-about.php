...
<main class="">
		...
		<section class="min-h-screen bg-cover bg-no-repeat bg-[45%_50%] sm:bg-cover  sm:bg-no-repeat sm:bg-[90%_50%] bg-deep-black bg-blend-overlay bg-opacity-10" style="background-image: url('<?php
